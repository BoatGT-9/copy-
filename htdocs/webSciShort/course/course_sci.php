            ...
            <div class="row">
                ...
                <div class="col-lg-8" >
                    ...
                    <article >
                        ...
                        <header class="mb-4">
                            ...
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1">การอบรมเชิงปฏิบัติการ การพัฒนา TPACK สำหรับครูวิทยาศาสตร์</h1>
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2"><i class="far fa-calendar-alt"></i> วันที่รับสมัคร 10 พ.ค. - 16 ก.ค. 2565</div>
                        ...
                        <section class="mb-5 course-body">
                          ...
                          <h5 class="fw-bolder mb-4 mt-5" id="list-item-31"><i class="far fa-calendar-alt"></i> ช่วงเวลาเรียน</h5>
                            ...
                            <h5 class="fw-bolder mb-4 mt-5" id="list-item-7"><i class="fas fa-file-alt"></i> การวัดผลประเมินผล</h5>
                              ...
                              <ul class="course-content fs-6">
                                <li>คะแนนการประเมินตนเองและประเมินแผนการจัดการเรียนรู้อยู่ในระดับค่อนข้างเชื่อมั่นขึ้นไป และมีคะแนนประเมินแผนอยู่ในระดับมาก</li>
                              </ul>
                            ...
                            <ul class="list-inline course-content fs-6 contact-course">
                              <li class="list-inline-item"><i class="fas fa-phone-square-alt"></i> <a href="tel:...">...</a> </li>
                            </ul>
                ...
                <div class="col-lg-4  d-none d-lg-block">
                  ...
                  <div id="list-example " class="list-group sticky-top ">
                    ...
                    <a class="list-group-item list-group-item-action" href="#list-item-3"><i class="far fa-calendar-alt"></i> วันรับสมัคร</a>
                    <a class="list-group-item list-group-item-action" href="#list-item-3"><i class="far fa-calendar-alt"></i> ช่วงเวลาเรียน</a>
                    <a class="list-group-item list-group-item-action" href="#list-item-5"><i class="fas fa-map-marker-alt"></i> สถานที่</a>

                    <a class="list-group-item list-group-item-action" href="#list-item-2"><i class="fas fa-bullseye"></i> วัตถุประสงค์</a>
                    <a class="list-group-item list-group-item-action" href="#list-item-4"><i class="far fa-user"></i> กลุ่มเป้าหมาย</a>
                    <a class="list-group-item list-group-item-action" href="#list-item-6"><i class="fas fa-chalkboard"></i> ขอบข่ายเนื้อหา</a>
                    <a class="list-group-item list-group-item-action" href="#list-item-7"><i class="fas fa-file-alt"></i> การวัดผลประเมินผล</a>
                    <a class="list-group-item list-group-item-action" href="#list-item-8"><i class="fas fa-award"></i> ผลที่คาดว่าจะได้รับ</a>
                    <a class="list-group-item list-group-item-action" href="#list-item-11"><i class="fas fa-clipboard-list"></i> กำหนดการ</a>
